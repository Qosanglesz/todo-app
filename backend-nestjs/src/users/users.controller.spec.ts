...
describe('UsersController', () => {
    ...
    describe('create', () => {
        ...
        it('should throw an error if user creation fails', async () => {
            ...
            service.create = jest.fn().mockRejectedValue(new UnauthorizedException('Error'));

            // Expect an error when creating the user
            await expect(controller.create(mockCreateUserDto)).rejects.toThrowError(UnauthorizedException);
        });
    });
});
